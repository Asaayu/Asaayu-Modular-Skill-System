...
name "asaayu_skill_system_driving"
description "This resource allows players to gain xp in a 'driving' skill, allowing them to level up and compete against each other. The higher the level, the easier wheelies will be."
version '1.0.0'
