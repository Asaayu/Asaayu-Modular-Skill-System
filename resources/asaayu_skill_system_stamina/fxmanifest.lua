...
name "asaayu_skill_system_stamina"
description "This resource allows players to gain xp in a 'stamina' skill, allowing them to level up and compete against each other. The higher the level, the longer the player can sprint."
version '1.0.0'
